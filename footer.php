    ...
    <div class="container overflow-hidden">
      <div class="row gy-4 gy-lg-0 justify-content-xl-between">
        <div class="col-12 col-md-4 col-lg-3 col-xl-2">
          <div class="widget">
            <a href="#!">
              <!-- <img src="./assets/img/bsb-logo.svg" alt="Dairy Farm" width="175" height="57"> -->
              <h3 class="text-dark">THE GYM</h3>
            </a>
          </div>
        </div>
        <div class="col-12 col-md-4 col-lg-3 col-xl-2">
    ...
    <div class="container overflow-hidden">
      <div class="row gy-4 gy-md-0 align-items-md-center">
        <div class="col-xs-12 col-md-7 order-1 order-md-0">
          ...
          © 2024 THE GYM Management. All rights reserved.
          </div>
          <div class="credits text-secondary text-center text-md-start mt-2 fs-8">
            Built by <a href="https://bootstrapbrain.com/" class="link-secondary text-decoration-none">THE GYM</a> with <span class="text-primary">&#9829;</span>
          </div>
        </div>
